package com.bookshop.order.vo;

import org.springframework.stereotype.Component;

@Component("orderVO")
public class OrderVO {
	private int order_seq_num;//주문번호
	private String member_id;//회원아이디
	private int order_id;//주문아이디
	private int goods_id;//상품아이디
	private String goods_title;//상품이름
	private int goods_sales_price;//상품가격
	private int total_goods_price;//총 상품가격
	private int cart_goods_qty;//장바구니에 담긴 제품 수
	private int order_goods_qty;//최총 주문 상품개수
	private String orderer_name;//주문자 이름
	private String receiver_name;//받는사람 이름
	private String receiver_hp1;//받는사람 집번호
	private String receiver_hp2;
	private String receiver_hp3;
	private String receiver_tel1;//받는사람 핸드폰번호
	private String receiver_tel2;
	private String receiver_tel3;
	
	private String delivery_address;//배송 주소
	private String delivery_message;//배송메시지 
	private String delivery_method;//배송방법
	private String gift_wrapping;//선물포장
