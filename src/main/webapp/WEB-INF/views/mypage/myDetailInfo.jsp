...
<script type="text/javascript">
	...
	function fn_modify_member_info(attribute){
		...
		if(attribute=='member_pw'){
			...
			var email2=frm_mod_member_email2;
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						...
						<td>
							<input type="password" name="member_pw" size="20" value="${memberInfo.member_pw}">
						</td>
						<td>
						...
						<td>
							<c:choose>
								<c:when test="${memberInfo.member_gender == '101' }">
									...
									<input type="radio" name="member_gender" value="101" checked="checked">남성
								</c:when>
								<c:otherwise>
						...
						<td>	
								...
								<c:forEach var="i" begin="1" end="100">
									<c:choose>
										<c:when test="${memberInfo.member_birth_y==1920+i }">
											<option value="${1920+i }" selected="selected">${1920+i }</option>
										</c:when>
										<c:otherwise>
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<input type="radio" name="member_birth_gn" value='1' checked="checked">음력
								</c:otherwise>
							</c:choose>
						</td>
						<td>
						...
						<td>
							...
							<c:choose>
								<c:when test="${memberInfo.smssts_yn=='true' }">
									<input type="checkbox" name="smssts_yn" value="Y" checked="checked"> 쇼핑몰에서 발송하는 SMS 소식을 수신합니다.
								</c:when>
								<c:otherwise>
						...
						<td>
							...
							<c:choose>
								<c:when test="${memberInfo.emailsts_yn=='true' }">
									<input type="checkbox" name="emailsts_yn" value="Y" checked="checked"> 쇼핑몰에서 발송하는 e-mail을 수신합니다. 
								</c:when>
								<c:otherwise>
					...
					<tr class="dot_line">
						...
						<td>
							<input type="text" id="zipcode" size="5" value="${memberInfo.zipcode }"> <a href="javascript:execDaumPostcode()">우편번호검색</a>
							<br>
							<p>
			...
			<table align="center">
				<tr>
					<td>
						...
						<input type="button" name="btn_cancel_member" value="수정 취소">
					</td>
				</tr>
			</table>
		</div>
