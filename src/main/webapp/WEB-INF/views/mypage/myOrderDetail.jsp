		...
		<div class="detail_table">
			<table>
				...
				<tr class="dot_line">
					...
					<td>${myOrderList[0].delivery_address}</td><!-- db에 br태그도 같이 저장되어있다. -->
				</tr>
				<tr class="dot_line">
			...
			<table>
				<tbody>
					<tr class="dot_line">
						<td><h2>이름</h2></td>
						<td>
							<input type="text" value="${orderer.member_name}" size="15" disabled="disabled">
						</td>
					</tr>
					<tr class="dot_line">
						<td><h2>핸드폰</h2></td>
						<td>
							<input type="text" value="${orderer.hp1 }-${orderer.hp2}-${orderer.hp3}" size="15" disabled="disabled">
						</td>
					</tr>
					<tr class="dot_line">
						<td><h2>이메일</h2></td>
						<td>
							<input type="text" value="${orderer.email1 }@${orderer.email2}" size="15" disabled="disabled">
						</td>
					</tr>
				</tbody>
			</table>
