...
<link href="${contextPath }/resources/css/basic-jquery-slider.css" rel="stylesheet" media="screen">
<link href="${contextPath }/resources/css/modile.css" rel="stylesheet" type="text/css">
