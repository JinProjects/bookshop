...
//2.변수명 오타
	...
	function init(){
		...
		var h_tel1=form_order.h_tel1; //hidden 데이터 DB에 저장된 번호
		var h_hp1=form_order.h_hp1;	//hidden 데이터 DB에 저장된 번호
	...
	function fn_show_order_detail(){
		...
		var r_delivery_method = frm.delivery_method; //radio타입
		...
		if(h_goods_fileName.length < 2 || h_goods_fileName == null){
		...
		//var p_order_goods_qty = documnent.getElementById("p_order_goods_qty");
		...
		p_receiver_name.innetHTML=receiver_name;
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
						<input type="radio" name="delivery_place"  value="기본배송지" onclick="restore_all()" checked>기본배송지 &nbsp;&nbsp;&nbsp;
				...
				<tr class="dot_line">
					...
					<td>
						...
						- <input type="text" size="10px" id="hp2" name="hp2" value="${orderer.hp2}">
						- <input type="text" size="10px" id="hp3" name="hp3" value="${orderer.hp3}"><br><br>
				...
				<tr class="dot_line">
					...
					<td>
						...
						</select> - <input type="text" size="10px" id="tel2" name="tel2" value="${orderer.tel2 }">
								  - <input type="text" size="10px" id="tel3" name="tel3" value="${orderer.tel3 }">
					</td>
				...
				<tr class="dot_line">
					...
					<td>
						...
						&nbsp;&nbsp;&nbsp; <input type="radio" id="gift_wrapping" name="gift_wrapping" checked value="no">아니요<br>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					<td>예치금</td>
					<td>
						<input type="text" name="discount_yechi" size="10">원/1000원
						&nbsp;&nbsp;&nbsp; <input type="checkbox">모두 사용하기
					</td>
				</tr>
				<tr class="dot_line">
					<td>상품권 전환금</td>
					<td cellpadding="5">
						<input type="text" name="discount_sangpum" size="10">원/0원
						&nbsp;&nbsp;&nbsp; <input type="checkbox"> 모두 사용하기
						</td>
				</tr>
				<tr class="dot_line">
					<td>OK 캐쉬백 포인트</td>
					<td cellpadding="5">
						<input type="text" name="discount_okcashbag" size="10">원/0원
						&nbsp;&nbsp;&nbsp; <input type="checkbox"> 모두 사용하기
					</td>
				</tr>
				<tr class="dot_line">
					<td>쿠폰할인</td>
					<td cellpadding="5">
						<input type="text" name="discount_cupon" size="10">원/0원
						&nbsp;&nbsp;&nbsp; <input type="checkbox">모두 사용하기
					</td>
				</tr>
			</tbody>
	...
	<table width="80%" class="list_view" style="background: #ccffff">
		<tbody>
			...
			<tr cellpadding=40 align="center">
				...
				<td><img width="25" src="${contextPath }/resources/image/equal.jpg"></td>
				<td>
					<p id="p_fianl_totalPrice">
			...
			<tbody>
				<tr>
					<td>
						...
						<input type="radio" id="pay_method" name="pay_method" value="제휴 신용카드" onclick="fn_pay_card()" >제휴 신용카드 &nbsp;&nbsp;&nbsp;
						<input type="radio" id="pay_method" name="pay_method" value="실시간 계좌이체" onclick="fn_pay_card()" >실시간 계좌이체 &nbsp;&nbsp;&nbsp;
						<input type="radio" id="pay_method" name="pay_method" value="무통장 입금" onclick="fn_pay_card()" >무통장 입금 &nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td>
						<input type="radio" id="pay_method" name="pay_method" value="휴대폰결제" onclick="fn_pay_phone()">휴대폰 결제 &nbsp;&nbsp;&nbsp;
						<input type="radio" id="pay_method" name="pay_method" value="카카오페이(간편결제)" onclick="fn_pay_phone()">카카오페이(간편결제)&nbsp;&nbsp;&nbsp;
						<input type="radio" id="pay_method" name="pay_method" value="페이나우(간편결제)" onclick="fn_pay_phone()">페이나우(간편결제)&nbsp;&nbsp;&nbsp;
						<input type="radio" id="pay_method" name="pay_method" value="페이코(간편결제)" onclick="fn_pay_phone()">페이코(간편결제)&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
					<td>
...
<center>
	...
	<a href="javascript:fn_show_order_detail();">
		<img width="125" src="${contextPath }/resources/image/btn_gulje.jpg">
	</a>
			...
			<table>
				<tbody align="left">
					...
					<tr>
						...
						<td>
							<p id="p_receiver_hp_num">받는사람 휴대폰번호</p>
						</td>
					</tr>
					<tr>
						<td width="200px">받는사람 유선전화번호:</td>
						<td>
							<p id="p_receiver_tel_num">받는사람 유선전화번호</p>
						</td>
					</tr>
					<tr>
